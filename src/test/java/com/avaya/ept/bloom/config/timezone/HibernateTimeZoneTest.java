package com.avaya.ept.bloom.config.timezone;

import com.avaya.ept.bloom.AvayaBloomAdminApp;
import com.avaya.ept.bloom.repository.timezone.DateTimeWrapper;
import com.avaya.ept.bloom.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneTest {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM bloom_date_time_wrapper where id=%d", fieldName, id);
    }
