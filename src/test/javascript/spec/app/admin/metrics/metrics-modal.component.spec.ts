...
import { BloomMetricsMonitoringModalComponent } from 'app/admin/metrics/metrics-modal.component';
import { BloomMetricsService } from 'app/admin/metrics/metrics.service';

describe('Component Tests', () => {
    describe('BloomMetricsMonitoringModalComponent', () => {
        let comp: BloomMetricsMonitoringModalComponent;
        let fixture: ComponentFixture<BloomMetricsMonitoringModalComponent>;
        let service: BloomMetricsService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [AvayaBloomAdminTestModule],
                declarations: [BloomMetricsMonitoringModalComponent]
            })
                .overrideTemplate(BloomMetricsMonitoringModalComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(BloomMetricsMonitoringModalComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(BloomMetricsService);
        });
