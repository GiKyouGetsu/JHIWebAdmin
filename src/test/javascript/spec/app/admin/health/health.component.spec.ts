...
import { BloomHealthCheckComponent } from 'app/admin/health/health.component';
import { BloomHealthService } from 'app/admin/health/health.service';

describe('Component Tests', () => {
    describe('BloomHealthCheckComponent', () => {
        let comp: BloomHealthCheckComponent;
        let fixture: ComponentFixture<BloomHealthCheckComponent>;
        let service: BloomHealthService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [AvayaBloomAdminTestModule],
                declarations: [BloomHealthCheckComponent]
            })
                .overrideTemplate(BloomHealthCheckComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(BloomHealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(BloomHealthService);
        });
