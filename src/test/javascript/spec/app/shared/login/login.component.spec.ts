...
import { BloomLoginModalComponent } from 'app/shared/login/login.component';
...
describe('Component Tests', () => {
    describe('LoginComponent', () => {
        let comp: BloomLoginModalComponent;
        let fixture: ComponentFixture<BloomLoginModalComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [BloomLoginModalComponent],
                providers: [
                    {
                ...
                .overrideTemplate(BloomLoginModalComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(BloomLoginModalComponent);
